...
from models import hard_core_boson
...
parser.add_argument("-t", type=float, default=1., help="nearest-neighbour hopping")
parser.add_argument("-tn", type=float, default=0., help="next-nearest-neighbour hopping")
parser.add_argument("-V", type=float, default=1., help="interaction")
parser.add_argument("-theta", type=float, default=0., help="tilting angle")
parser.add_argument("-mu", type=float, default=0., help="tilting angle")
...
def main():
    ...
    model = hard_core_boson.HCB(t=args.t, tn=args.tn, V=args.V, theta=args.theta, mu=args.mu, tiling=args.tiling)
    ...
    if args.tiling == "BIPARTITE":
        ...
        raise ValueError("Invalid tiling: "+str(args.tiling)+" Supported options: "\
            +"BIPARTITE, 2SITE, 4SITE, 8SITE, 9SITE")
    ...
    obs_values, obs_labels = model.eval_obs(state,ctm_env,args.tiling)
