...
def combine_ipess_into_ipeps_test(A, B, C, R_up, R_down):
...
def main():
    ...
    def loss_fn(state, pess, ctm_env_in, opt_context):
        ...
        test.write_to_file("pess-D4.json", normalize=True)

        T1 = combine_ipess_into_ipeps_test(A, B, C, R_up, R_down)
        ...
        A2, B2, C2, R2_up, R2_down,\
        A3, B3, C3, R3_up, R3_down,\
        A4, B4, C4, R4_up, R4_down,\
        A5, B5, C5, R5_up, R5_down,\
        A6, B6, C6, R6_up, R6_down,\
        A7, B7, C7, R7_up, R7_down,\
        A8, B8, C8, R8_up, R8_down,\
        A9, B9, C9, R9_up, R9_down= pess
        ...
        T3 = combine_ipess_into_ipeps(A3, B3, C3, R3_up, R3_down)
        T4 = combine_ipess_into_ipeps(A4, B4, C4, R4_up, R4_down)
        T5 = combine_ipess_into_ipeps(A5, B5, C5, R5_up, R5_down)
        T6 = combine_ipess_into_ipeps(A6, B6, C6, R6_up, R6_down)
        T7 = combine_ipess_into_ipeps(A7, B7, C7, R7_up, R7_down)
        T8 = combine_ipess_into_ipeps(A8, B8, C8, R8_up, R8_down)
        T9 = combine_ipess_into_ipeps(A9, B9, C9, R9_up, R9_down)
        """
        """
        ...
        unit = OrderedDict(unit)
        test = IPESS(unit, vertexToSite=lattice_to_site)
        test.write_to_file("pess-D2.json", normalize=True)
        """
        #sites[(0,1)] = T1
        #sites[(0,1)] = T2
        #sites[(0,2)] = T3
