...
class triangle():
    def __init__(self, j1=1.0, j2=1.0, global_args=cfg.global_args):
        r"""
    ...
    def energy_2x2_9site(self,state,env):
        ...
        We assume iPEPS with 3x3 unit cell containing nine tensors A, B, C with
        simple PBC tiling::
        ...
        for the nearest and next-neaerest neighbour pairs are evaluated::  
            ...
            A3--1B   B3--1C   C3--1A   D3--1E
            2    2   2    2   2    2   2    2 ...
            0    0   0    0   0    0   0    0
            D3--1E & E3--1F & F3--1D & G3--1H
        ...
        energy_per_site = 2.0*self.j1*energy_nn/36.0 + self.j2*energy_nnn/9.0
    ...
    def energy_2x2_2site(self,state,env):
        ...
        for coord in state.sites.keys():
            ...
            energy_nn += torch.einsum('ijklabcd,ijklabcd',tmp_rdm,self.h2x2_nn)
            energy_nnn += torch.einsum('ijklabcd,ijklabcd',tmp_rdm,self.h2x2_nnn)
        energy_per_site = 2.0*(self.j1*energy_nn/8.0 + self.j2*energy_nnn/2.0)
        return energy_per_site
